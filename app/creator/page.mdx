<section className="max-w-2xl pt-32 pb-20 px-4 mx-auto text-sm *:leading-6 *:selection:bg-emerald-200 *:selection:text-emerald-900 [&_p]:text-justify [&_img]:rounded-sm [&_img]:select-none [&_img]:drag-none polca-dotted">
...
Hey! I'm Aditya Mayukh Som, a senior at `Jadavpur University, India`. When I'm not trying to finish the syllabus for semester exams, you'll find me knee-deep in code, building applications, grinding DSA or geeking out over scalable architectures. Huge nerd (but am I?).
...
I recently completed my internship as an `Intern Analyst` at `Wells Fargo`, building machine learning models for financial analysis. Turns out the ancient art of meeting project deadlines was actually the biggest takeaway.
